...
class TestNotification extends PHPUnit_Framework_TestCase
{
            ...
            P\ios(
                ...
                array(
                    ...
                    "button_actions" => array(
                        "yes" => array("add_tag" => "tapped_yes"),
                        "no" => array("add_tag" => "tapped_no")
                    )
                ),
                true,
    ...
    public function testAndroid()
    {
        ...
        $this->assertEquals(
            P\android(
                ...
                array(
                    "type" => "big_text",
                    "big_text" => "Holy moly, this is big!",
                    "title" => "Holy bigness!",
                    "summary" => "hi"
                ),
                "Stuff",
    ...
    public function testAmazon()
    {
        ...
        $this->assertEquals(
            P\amazon("Hello", "consolidationKey", 100, "NotificationTitle", "NotificationSummary",
                array("foo" => "bar"), array(
                    "type" => "big_text",
                    "big_text" => "Holy moly, this is big!",
                    "title" => "Holy bigness!",
